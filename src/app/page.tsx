      ...
      <div className="container mx-auto px-4 py-16">
        <header className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
            Take control of your finances with our beautiful, accessible expense
        ...
        <main className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <div
              className="expense-card p-6 animate-slide-up"
            ...
            >
              ...
              <p className="text-slate-600 dark:text-slate-300">
                Your financial data stays secure with industry-standard
                protection
              </p>
            </div>
          ...
          <div className="expense-card p-6 mb-8">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="category-badge category-food">
                Food & Dining
              </span>
              <span className="category-badge category-transport">
                Transportation
              </span>
              <span className="category-badge category-entertainment">
                Entertainment
              </span>
              <span className="category-badge category-shopping">Shopping</span>
              <span className="category-badge category-health">
                Health & Fitness
              </span>
              <span className="category-badge category-utilities">
                Utilities
              </span>
